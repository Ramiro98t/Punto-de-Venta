<?php
    ...
    $sql = "SELECT * FROM venta_producto INNER JOIN producto ON venta_producto.id_producto = producto.id WHERE id_venta = $term";
    ...
    if (!$fila) echo 0;     // En caso de no encontrar coincidencias
        ...
        <div class="columns">
            <p class="column subtitle is-four-fifths has-text-info">
                Descripcion
            </p>
